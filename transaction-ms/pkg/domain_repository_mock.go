...
//
//	mockgen -package=pkg -source=internal/domain/repository.go
//
...
func (mr *MockCreditCardTransactionRepositoryMockRecorder) Create(c any) *gomock.Call {
...
func (mr *MockCreditCardTransactionRepositoryMockRecorder) DeleteByTransactionID(TransactionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCreditCardTransactionRepositoryMockRecorder) GetByTransactionID(TransactionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCreditCardTransactionRepositoryMockRecorder) GetList(p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCreditCardTransactionRepositoryMockRecorder) Update(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockTransactionStatusRepositoryMockRecorder) Create(t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTransactionStatusRepositoryMockRecorder) GetByCreditCardTransactionID(TransactionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
