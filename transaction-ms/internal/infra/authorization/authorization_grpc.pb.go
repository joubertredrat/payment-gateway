...
const (
	Authorization_Authorize_FullMethodName = "/service.Authorization/authorize"
)
...
type AuthorizationClient interface {
	Authorize(ctx context.Context, in *CreditCardRequest, opts ...grpc.CallOption) (*CreditCardResponse, error)
}
...
func (c *authorizationClient) Authorize(ctx context.Context, in *CreditCardRequest, opts ...grpc.CallOption) (*CreditCardResponse, error) {
	out := new(CreditCardResponse)
	err := c.cc.Invoke(ctx, Authorization_Authorize_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorizationServer interface {
	Authorize(context.Context, *CreditCardRequest) (*CreditCardResponse, error)
...
func (UnimplementedAuthorizationServer) Authorize(context.Context, *CreditCardRequest) (*CreditCardResponse, error) {
...
func _Authorization_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).Authorize(ctx, req.(*CreditCardRequest))
	}
...
var Authorization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.Authorization",
